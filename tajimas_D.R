...
for (i in 0:10){
  rf=i*0.1
  print(rf)
  all_genome = read.dna(paste("H:/sim/genome_49_all_rf_",format(rf, digits=1, nsmall=1),".fas",sep=''), format = "fasta")
  gene2 = read.dna(paste("H:/sim/genome_49_gene2_rf_",format(rf, digits=1, nsmall=1),".fas",sep=''), format = "fasta")
  gene3 = read.dna(paste("H:/sim/genome_49_gene3_rf_",format(rf, digits=1, nsmall=1),".fas",sep=''), format = "fasta")
  gene4 = read.dna(paste("H:/sim/genome_49_gene4_rf_",format(rf, digits=1, nsmall=1),".fas",sep=''), format = "fasta")
  intergene = read.dna(paste("H:/sim/genome_49_intergene_rf_",format(rf, digits=1, nsmall=1),".fas",sep=''), format = "fasta")
